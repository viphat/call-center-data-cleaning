...
export const buildTemplate = (templateFilePath, isValid = true) => {
  ...
  worksheet.getCell('F3').value = 'Cần Thơ';
  ...
  worksheet.getCell('N7').font = worksheet.getCell('A7').font;
  worksheet.getCell('N7').border = worksheet.getCell('A7').border;
  worksheet.getCell('N7').alignment = worksheet.getCell('A7').alignment;

  worksheet.getCell('O7').font = worksheet.getCell('A7').font;
  worksheet.getCell('O7').border = worksheet.getCell('A7').border;
  worksheet.getCell('O7').alignment = worksheet.getCell('A7').alignment;

  worksheet.getCell('P7').font = worksheet.getCell('A7').font;
  worksheet.getCell('P7').border = worksheet.getCell('A7').border;
  worksheet.getCell('P7').alignment = worksheet.getCell('A7').alignment;
