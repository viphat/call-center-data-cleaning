...
export const generateReportTemplate = (batch, source, outputDirectory) => {
  return new Promise((resolve, reject) => {
    ...
    buildReportFirstColumnType3(worksheet, 26, 'Valid database (value) - base all');
    ...
    buildReportFirstColumnType2(worksheet, 22, 'Illogical data');
    buildReportFirstColumnType2(worksheet, 27, 'Email missing');
    ...
    buildReportFirstColumnType1(worksheet, 16, "Duplication within same year (2024)");
    buildReportFirstColumnType1(worksheet, 17, "Duplication with 2023 data");
    buildReportFirstColumnType1(worksheet, 18, "Duplication with 2022 data");
    buildReportFirstColumnType1(worksheet, 19, "Duplication with 2021 data");
    buildReportFirstColumnType1(worksheet, 20, "Duplication with 2020 data");
    buildReportFirstColumnType1(worksheet, 21, "Duplication with 2019 data");

    buildReportFirstColumnType1(worksheet, 23, "Illogical phone number");
    buildReportFirstColumnType1(worksheet, 24, "Illogical Date of pregnancy/Baby Delivery");
    buildReportFirstColumnType1(worksheet, 25, "Illogical Other");
...
function buildDataRow(worksheet, rowIndex, cellIndex) {
  ...
  if (rowIndex == 6 || rowIndex == 7 || rowIndex == 12 || rowIndex == 22 || rowIndex == 26 || rowIndex == 27) {
    bold = true;
  }

  if (rowIndex == 7 || rowIndex == 12 || rowIndex == 22) {
    row.getCell(cellIndex).fill = {
      type: 'pattern',
      pattern: 'solid',
      fgColor: { argb: 'FF00B0F0' },
  ...
  if (rowIndex == 7 || rowIndex == 12 || rowIndex == 22 || rowIndex == 26) {
    color = { theme: 0 };
  }
